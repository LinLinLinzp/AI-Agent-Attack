"""Aggressive C variant: GPT can select K3/K2 templates while gemma stays on K1.
The intent is to test whether higher raw score density can move toward 100+.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[gpt_k3_k2_aggressive] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
