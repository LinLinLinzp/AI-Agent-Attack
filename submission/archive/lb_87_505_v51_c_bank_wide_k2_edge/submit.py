"""V51 C bank-wide / K2-edge follow-up.
Keeps the 88.965 C replay ledger and tests a narrow validated-bank/K2 selection tweak.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v51_c_bank_wide_k2_edge] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
