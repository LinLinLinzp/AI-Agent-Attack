"""V50 aggressive probe-to-emit jump candidate.
Same idea as V49, but sizes closer to the replay edge for a 100+ attempt.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        deadline = time.monotonic() + min(budget, 480.0)
        ...
        print(
            "[v50_probe_emit_aggressive] selected=%s unit=%.2f returned=%d cap=%d score_est=%.2f | %s"
