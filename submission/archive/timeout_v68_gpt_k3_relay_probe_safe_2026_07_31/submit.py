"""V68 GPT-only K3 relay probe-safe engine.
...
winner. Gemma remains K1-only. Competition sandbox only.
"""
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v68_gpt_k3_relay_probe_safe] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
