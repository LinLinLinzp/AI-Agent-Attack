"""V56 C exact tail-release candidate.
Keeps the V37/C full-hop exact validation path, but releases only the generation
tail reserve and resets cold-start slowest after warm-up.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v56_c_exact_tail_release] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
