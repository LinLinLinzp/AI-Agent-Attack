...
Uses the external 88.515 single-post race with a lower replay cap.
...
REPLAY_SAFE = 0.982  # 8838s cap, adding headroom after exact-control timeout
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v44_k1_replay_safe_reference] selected=%s cost=%.3f fill_unit=%.2f banked=%d returned=%d "
