"""V93 double channel collapse. Pre-fills analysis AND final channels to skip both
reasoning and wrap-up generation. K1_REPLAY_SAFE=0.95, FILL_HOPS=1. Competition sandbox only."""
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[V93] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
