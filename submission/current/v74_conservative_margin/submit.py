"""V74 conservative margin engine.
Exact V62 source with K1_REPLAY_SAFE reduced from 0.99 to 0.97.
This caps the returned set's replay cost at 8730s instead of 8910s,
providing a ~180s safety buffer. This is a hedge against private LB
having a tighter replay budget, ensuring the submission completes
replay without timeout at the cost of fewer candidates.
...
# V74 uses K1_REPLAY_SAFE = 0.97 (vs V62's 0.99) to provide a ~180s safety
# buffer. This is a hedge against private LB having a tighter replay budget.
# The trade-off is approximately 20 fewer candidates at ~8.7s/cell.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v74_conservative_margin] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
