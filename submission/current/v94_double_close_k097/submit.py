"""V94 double channel collapse + K=0.97. Pre-fills analysis AND final channels.
K1_REPLAY_SAFE=0.97, FILL_HOPS=1. Aggressive replay budget push. Competition sandbox only."""
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[V94] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
