"""V90 hops-1 fill + micro-opt. K1_REPLAY_SAFE=0.95, PROBE_REPS=2, RACE_EXTRA_REPS=1,
MARGIN_S=20, SLOWEST0=15, 3 templates. Fill probes at hops=1 while replay cost is sized
from 8-hop probe measurements. Competition sandbox only."""
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v90_hops1_micro_opt] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
