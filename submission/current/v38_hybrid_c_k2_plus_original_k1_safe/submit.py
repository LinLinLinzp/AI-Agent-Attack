"""Hybrid C variant: GPT keeps the validated K2 probe while K1 returns closer to 88.515.
The intent is to recover safe K1 throughput without losing C's GPT K2 upside.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[hybrid_c_k2_original_k1_safe] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
