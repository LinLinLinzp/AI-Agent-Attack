"""Model-aware K2 probe built on the 88.515 K1 replay ledger.
GPT can select validated two-post templates; gemma stays on the safer K1 path.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[gpt_k2_probe] selected=%s k=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
