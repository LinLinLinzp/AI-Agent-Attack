"""V47 conservative EXFIL + CONFUSED_DEPUTY stack probe.
Keeps C's K1/K2 baseline and lets K1+CD stack templates win only by raw/sec.
...
class AttackAlgorithm(AttackAlgorithmBase):
    ...
    def run(self, env: Any, config: AttackRunConfig | None) -> list[AttackCandidate]:
        ...
        print(
            "[v47_c_cd_stack_conservative] selected=%s k=%d cd=%d score=%.3f cost=%.3f fill_unit=%.2f banked=%d returned=%d "
