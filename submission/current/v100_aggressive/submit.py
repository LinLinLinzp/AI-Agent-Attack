"""V100 aggressive volume maximizer. Same framework as V98 but with factor=3.0
(based on gateway replay validation: search 10s vs replay 0.93s = 10.75x).
Uses new rule "replay timeout preserves partial score" as downside protection.
If actual replay ratio is ~6-11x (gateway data), returns MAX_CANDIDATES=2000.
If actual ratio is lower, replay may timeout but partial score is preserved.
Hedges against V98's factor=2.0 being too conservative.
